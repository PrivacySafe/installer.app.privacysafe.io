 ...
 * device, etc.
 */
 declare namespace web3n.device {

	interface Service {
		openFileDialog: files.OpenFileDialog;
		openFolderDialog: files.OpenFolderDialog;
		saveFileDialog: files.SaveFileDialog;
		saveFolderDialog: files.SaveFolderDialog;
	}
